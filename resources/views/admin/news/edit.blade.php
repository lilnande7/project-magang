                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('excerpt') is-invalid @enderror" 
                                  ...
                                  name="excerpt" 
                                  rows="3" 
                                  placeholder="Brief description of the news (optional)...">{{ old('excerpt', $news->excerpt) }}</textarea>
                    ...
                    <div class="row g-2">
                        <div class="col-12">
                            <small class="text-muted">
                                ...
                                Created by: <strong>{{ $news->author->name }}</strong>
                            </small>
                        </div>
                        <div class="col-12">
                            <small class="text-muted">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div id="imagePreview" class="d-none">
                        <img id="previewImg" src="#" alt="New Image Preview" class="img-fluid rounded">
...
$(document).ready(function() {
    ...
    $('#removeCurrent').click(function() {
        if (confirm('Are you sure you want to remove the current image?')) {
            ...
            // You could add a hidden input to mark image for deletion
            $('<input>').attr({
                type: 'hidden',
