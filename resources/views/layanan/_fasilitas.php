    ...
    <div class="container">
        ...
        <div class="fasilitas-detail">
            <div class="detail-image">
                <img src="<?= base_url('assets/img/areabaca.jpeg') ?>" alt="Science & Technology">
            </div>
        ...
        <div class="fasilitas-detail reverse">
            <div class="detail-image">
                <img src="<?= base_url('assets/img/Hotspotarea.jpeg') ?>" alt="Internet Area">
            </div>
        ...
        <div class="fasilitas-detail">
            <div class="detail-image">
                <img src="<?= base_url('assets/img/areabaca.jpeg') ?>" alt="Hotspot Area">
            </div>
